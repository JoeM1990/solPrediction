...
function normalizeData(data) {
    const minValues = [6, 25, 10, 150, 0];  // valeurs minimales pour chaque caractéristique
    const maxValues = [7, 50, 50, 250, 100];  // valeurs maximales pour chaque caractéristique
